...
_ release the reference to Warrenton Records Center in the
Lopez Report (p. 44).
...
cover needs to be protected. In brief, significant damage to _
...
2. (8S) As background, the Central Intelligence Agency has
...
wrc and the Agency, is classified SECRET vice CONFIDENTIAL. WTC
...
SUBJECT: {2)Re: Release Issue/JFK Board
...
certairi European stations and liaison relationships. The White House directed the
...
>» (8) The documents at issue contain the term “Warrenton. Records Center” :
...
7 (8) Pursuant to classification guidelines promulgated by the Director of
Central Intelligence, this fact is currently and properly classified at the

SECRET level.
a

3 (S) Because of the sensitivity of CIA records, the Archivist of the United
...
but also houses thé Diplomatic Telecommunications Service
...
e® covert employees of the Office of Technical
...
role in the Bosnian theater; a

The Office of Technical Collection is a component within the

Directorate of Science and Technology which is responsible for the _
...
e covert employees of the Office of External
...
e senior officials of the Administration,
...
e Station C serves as the CIA’s primary transmit site for
...
e Station D serves as the Agency’s primary receive site for
world-wide classified and encrypted communications with |

5 (8) The Office of External Development (OED). is one of the most sensitive
...
‘(8) The various DO area divisions utilize WTC for immersion language
...
Hence, if WTC was associated with CIA, then the presence of a student at WIC
...
SUBJECT: (S) Required Protection of Warrenton Training Center _
' as CIA Facility _
...
SUBJECT: (S) Required Proteetion of Warrenton Training Center
: as CIA Facility
...
_@ (8s) ex, f=} d ediate irment to Physical an
Personnel Se ty: Our Department of the Army cover -
...
Simply stated, CIA isa target | for both hostile
...
7 (S$) As detailed on the attached annotated photographs, the array of
...
a public road and the sécond is approximately 600 feet. There are no
...
® (8) The current Kasi prosécution provides ample evidence of the risks
...
or imply that they know that WIC is a CIA facility and, hence, it would appear
...
e (S) Likely Future Compromise of Covert Employees in.
...
e (8) Loss of Emergency Relocation Site for DCI: ;
...
of the fact that WIC would serve as such an ERS site --
...
2° (8) We know from captured STASI (the former intelligence service of East
...
attributable basis to czA.™ These items are acquired in
...
* (8) Loss of Secure Training and Conference Capability: |
Station B is often used as a conference facility not only
by Agency groups, but also by other US Government a
...
e (8s) Heightened Scrutiny of Classified Mission: For more
...
e (Ss) Endangerment of Department of State Officers and
...
(8) It is not unreasonable to believe that the loss of cover for WIC would
...
g:\ipcerdwp\general\lss\arrb_wtc.doc
