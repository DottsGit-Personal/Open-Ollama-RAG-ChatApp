...
(U) To date over {§00/ CIA employee names, mostly DO,
...
that approximately (18007 names have been released to date in
the JFK review].
...
ox 48, theré is a Position Control Register (155 pages) /

l1l_employees in Far East Division including the’
...
(AIOU) That the Agency re-visit. the name issué with the
...
(C) [Note: éré is also thé issue of State Department).
equities and the impact of officially acknowledging as CIA /
{hundreds of officers who were under official State cover. ] 9
...
states that the proofs required to postpone release ofa
...
a vis staying with his or

(either current or retired) vis
...
employee names as contained in JFK records. Over names
...
such as Phonedac. Like the IRS and OPM, the Gredit union /
...
of his ox her true name via these JFK documents which will
...
cd UNCLASSIFIED Tap inner, !
fo ~~ ROUTING AND RECOR
: SUBJECT: * (Optional) 7
...
To: id Gteer designation, room number, and

fom 61.0 “sorter” (] secReT  [[] CONFIDENTIAL INTERNAL = ]_sUNCLASSIFIED
