...
SUBJECT: ‘Release of JFK Assassination Records vo
...
previously blown or exposed they can be released. There may be J
...
2. QI realize that the above guidelines continue to mean
...
or November 1968. The DCI sent .a oiettae of condolence to his wife.
...
“I have just talked with(beg Sanders) DC/LA Division,
...
staf£ and complements information provided in previous
...
SUBJECT: (S) Protection of fIJDECANTER Cryptonym
...
of a CIA source (LJDECANTER) . It is our considered judgment that
the release of this” “eryptonym, in the particular context of the
given document (SX-59777 of  -“15 December 199k), and juxtaposed }

qwith the Los _Angeles - Times article of. “29, December'.1994/" would
...
would otherwise be releasable. a
...
cl BY! 0619849} 0619849 c/IRGIOIM
...
assessment _is supported by reporting from another source
w(identity..redacted_but,_ in_fact, IJDECANTER) .. It concludes_by. a
stating that this source (TJDECANTER) has had his "... bona fides’S
fully established [by CIA]."“ It is this final fact which is<i
critical to our request. By having released this substantive
infoxmation -- "bona fides ... established" -- and by o rwise
| having\IJDECANTER known to the public in true name and <rypt, we |
; must protect the cryptonym here so that the key intelligence :

judgment of GIA is not compromised.

N\ 2

5. (C) The: practice of counterintelligence”(CI) -- and

hence the issue of\damage to national security 7 proceeds from
four basic questions: ,

¢ what NG compromised?
khoots received the

e what foreign intelligence s
information?

tre

e what understanding of te ‘information did the
service(s) have?

e¢ what information id the intelhigence service(s) |
...
be acquired througha”combination of confessions, ol ygraph
...
| for both the aequiring intelligence service e and the target
intelligence Service.

7. Sy With further respect to question three, if a
import hey wi fully understands the substance (i.e., \
) aie
...
example of this is the Boyce/Lee espionage case. The ere \\ {

co romised was a as 8 Seemingly innocuous operational manual for a
...
H information they had acquired through signals intelligence,
...
1 took extensive countermeasures and invaluable intelligence was

| | directly and immediately lost.

a4 8. (S) With further respect to.question four, we have the :
...
| Russians know that Sergei PAPUSHIN (i.e., IJDECANTER) defected to j
(i the United States; they know or suspect what he told the US; they
...
ito the Russians the final piece of the PAPUSHIN puzzle and allow
.ithem to have the ultimate benefit from what heretofore has been a
...
po ars (sy tn ‘Sum, “question 4 -- bona fides -- is the CI key.
...
fare to preclude a substantial CI benefit to the Russian Federal
...
- [of co gourse,—information—on_ the public record. via the media.
...
‘Russians “are fully éxpect—that, ‘ th
United States is considering avenues of reprisal. This|.
i
eta release might well be viewed as a public move
...
know_thisfor-certain~ >

e And third, there is an equitable issue. oma CIA. has
jy never_officially. confirmed that PAPUSHIN’was a defector
| in our custody and under our controly the CIA has .
...
| oeguably harmful _to_ living persons.
...
CIA TALKING POINTS |
re Protection of ‘{IGDECANTERY Cryptonym
...
document_(SX=59777. of ‘15. December 1991), and juxtaposed!

Ath the Los Angéles Times article’ of” “23 December 1997,
...
e result in concomitant damage to US counter- intelligence
interests, and,

e have a chilling impact on cooperation of current and
...
eo if desired, a textual explanation of the cryptonym in the
...
(KGB) of the former USSR; (specifi. , :

“Chief Directorate hii
...
e The released version reports that a Soviet official
(Boris ZHURAVLEV) had provided information to the effect
that OSWALD was a KGB source.

‘e It continues by stating that CIA did not believe
ZHURAVLEV to be a credible source.

e It continues by stating that this CIA assessment is

(fedacted; ‘but sin. faet,

e Tecconcludes by stating that this source “(IJDECANTER) has
Hadhis "... bona fides ... fully established [by-CIAL.-"
ne
a =

e af is this~fine) fact which is oritical,

are

So

¢ \By having released thi s> ubstantive information -- “bona
fides -.- establi hed". “AND by otherwise having

IJDECANTER known -to the public in true hama~and_ crypt,
THEN Wem IST’ PROTECT the cxyptonym here so _fae the Rey.
...
SECRET
a" THE practice of countérintelligence (€I) -— and hence the
...
answer and xe is the critical information that we must
...
e But we must protect his cryptonym here, in this j
...
- a)
| * In ourjudgment, the Russians are. fully _expect—that,—after— \
reprisal.

® This specific release might well be viewed as a public move to
| oper them and it would serve only to exacerbate tensions.
...
“Phe CIA has never officially confirmed that PAPUSHIN was a
...
g:\irg_ frontoffice\general\1ss\arrbijtp.doc
...
information. The major relevant L! projects (LIENVOY, LITEMPO, LICALLA, etc.) have had both the
full cryptonym and most of the details released. Na -

Station-and-Operation Directorate division fistories | are ‘among the most sensitive documents
...
7 the widest of lenses, do not appear to be relevant to the JFK story,is very great.
