...
17 March, at 2:00 p.m., in{2C06 IP Bidg.} I regret the short ™
...
1- Can you describe the cable process. in place: in ny Agency

during the

1960-1964 time » period?

Prior to 1962° messages were delivered 1 to the | DPD
(Development Products Division) at 1717 H Street or. to the

né addition there

Communications Center at “Lu” LCL.
also was a Q building that ‘received apectal traffic.
After 1962 messages came into the CIA. Hea uarters

were processed in different areas depend ng.on': a the

types of traffic.

Imagery traffic would be gent to to.a specttie ‘floor

Messages came in from the field via the B: andy

Channel oF wETTeary-c
...
on a desk at Headquarters? - precited

Messages sent from a field site d be passed to a ca

communicator, eaceybted and transmitted via ‘
...
requirements. They then would have a typist type the 3
...
Administrative-Internal Use Only Pagel
...
_° Information. Management Goals , |
...
@ Records Management - -iflaber) tage
@ Classification Management - deonlew aloe
@ Information Disclosure - ates ee
@ Information Automation - edeinhavst

an g:\iro\briefing\itkbref.ppt ’ Administrative-Internal Use Only Page 4
...
Information Services o Management in the Agency
[A
- [_Ditnfo Mgt * | , |
77 Recruitmen
& Training* ~~
...
‘ | gNiro\briefing\fkbref.ppt Administrative-Internal Use Only Page7
...
* The DA/IRO is the 2 Deputy Director for Administration’ s
...
¢ Special Searches & Other Release Programs.
 ...
 g:Niro\briefing\jfkbref.ppt _Administrative-Internal Use Only Page 8
...
' g:Mro\briefing\jfkbref.ppt Administrative-Internal Use Only Page 9
...
Office of Medical Services (OMS) _

Office of Information Technology (OIT)
Office of Training & Education (OTE)

____gNiro\briefing\jfkbref.ppt Administrative-Internal Use Only. Page 10
...
* Records Life Cycle aes poses |
¢ Creation nie y
* Maintenance & use mot Lo

¢ Disposition
File mn ela |
| z Lpb inter btn
* ___ g:Niro\briefing\jfkbref.ppt Administrative-Internal Use Only fe O6C aca erored Page 11.
, fem Wt) te DEL poe :
...
Directorate « of Administratlo
_ ‘DA Records" a

Records Control Schedules re
lag “= ¢ Temporary ae
SEE TT ¢ Permanent jlword. tl fect Bi vcore
: ai Records Storage-,, own Soe
‘ange + Short term

Lone hecountability an
ptZ7” — » Personal - EY anager fe fags

* Organization |
* Search & Retrieval

g:\iro\briefing\fkbref.ppt , Administrative-Internal Use Only Page 12
...
g:Nro\briefing\fkbret.ppt Administrative-Internal Use Only Page 13
...
soe Background Use Only
; Do Not Reproduce

RETURN TO CIA
~~ Becaromid se6 Only a
; Do Not Reproduce
...
1. What records are maintained on contract personnel?-> oF pe ara \ bike
=>

|
_ 1. For the. period between 1955-65, what was the universe of files that OS had on
individuals o groups?
2. How are Office of Security records indexed? car du \e pune Ws
3. What was the function of the Office of Security /: Security Research Staff (08 / SRS)? 4
Why were’ defector records kept in this component? de< ....4c4 gad Ney: chin

4. In the: OS/SRS memo of Oct. 31, 1960, written by Marguerite D. Stevens, the file
numbers of several defect sare listed: “Robert Edward Webster, EE-18854; Lee
Harvey Oswald, MS-11164; Libero Ricciardelli, MS-8295; Vladimir Sloboda, MS-10565;

_ and Joseph Dutkanicz, MS-10724. " What do the “MS” and “EE” file prefixes designate? _
...
, BF Does OS process security clearances for non-employees (e.g. sources) to receive
...
‘wo Oswald? Why did OS have any files on Oswald?
