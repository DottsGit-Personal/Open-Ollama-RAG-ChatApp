...
‘El NCLASSIFIED USE ONLY - 1). CONFIDENTIAL [1] SECRET
, a ». JUTING AND RECORD SHEET

SUBJECT: (Optional)

TO: (Officer designation, room number, ond
building) . COMMENTS (Number each comment to show from whom
ae : to whom. Draw a line acress column after, each comment.)

feet G10 “sme (] secReT  [[) CONFIDENTIAL’ [[] INTERNAL = [7] UNCLASSIFIED
...
quarters to (Chi é) in May 1973, and if this manuscript is the
yroper vehicle to surface such information.

wd
fe-chnone ret av.Gell Hate

“RY "CONFIDENTIAL cs noe
...
decisions following an alcvholic luncheon. This implication
...
[2-32(Brazzaville.) Other than in the change in name there is no
